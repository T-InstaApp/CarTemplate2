...
import com.example.cartemplate2.databinding.ImageGroupNameListItem2Binding
...
class ImageGroupNameDataAdapter2(
    var orderMenuData: List<ImageUrlWithGroupName>,
    private val listener: RecyclerViewClickListener,
    val context: Context
) :
    RecyclerView.Adapter<ImageGroupNameDataAdapter2.OrderViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = OrderViewHolder(
        DataBindingUtil.inflate(
            ...
            R.layout.image_group_name_list_item2, parent, false
        )
    )
    ...
    inner class OrderViewHolder(
        val imageGroupNameListItemBinding: ImageGroupNameListItem2Binding
